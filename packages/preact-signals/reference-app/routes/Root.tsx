...
export default function Root() {
  ...
  let hooks = {
    useNavigationType: JSON.stringify(useNavigationType()),
    useLocation: JSON.stringify(useLocation()),
    useNavigation: JSON.stringify(useNavigation()),
    useMatches: JSON.stringify(useMatches()),
  };
  ...
  return (
    <>
      <h1>Root Layout (Preact Signals)</h1>
      <nav>
